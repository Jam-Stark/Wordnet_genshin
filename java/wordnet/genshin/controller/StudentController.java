...
public class StudentController {
    ...
    @RequestMapping(value = "opt/{s_id}",method = RequestMethod.GET)
    public MessageAndData search(@PathVariable(value = "s_id") int id){
    ...
    @RequestMapping(value = "del/{s_id}",method = RequestMethod.DELETE)
    public MessageAndData delete(@PathVariable(value = "s_id")int id){
